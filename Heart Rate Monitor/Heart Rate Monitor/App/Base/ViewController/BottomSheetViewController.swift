...
open class BottomSheetViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    public lazy var closeButton: UIButton = {
        let view = UIButton()
        view.setImage(UIImage(named: "ic-close")?.withRenderingMode(.alwaysTemplate), for: .normal)
    ...
    open func layoutViews() {
        ...
        view.isUserInteractionEnabled = true
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(outsideTapped))
