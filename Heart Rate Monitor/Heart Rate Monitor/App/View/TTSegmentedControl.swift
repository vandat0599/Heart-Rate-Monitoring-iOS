...
open class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var defaultTextColor: UIColor = UIColor(named: "label")!
    @IBInspectable open var selectedTextColor: UIColor = UIColor.white
    @IBInspectable open var useGradient: Bool = true
    
    @IBInspectable open var containerBackgroundColor: UIColor = UIColor(named: "backgroundGray")!
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColors: [UIColor]? = [UIColor(named: "pink")!, UIColor(named: "purple")!]
    @IBInspectable open var thumbShadowColor: UIColor = UIColor.black
...
//    @IBInspectable open var cornerRadius: CGFloat = 9 // for rounded corner radius use negative value, 0 to disable
...
extension TTSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrame() {
        ...
        thumbView.layer.cornerRadius = cornerRadius < 0 ? 0.5 * thumbView.frame.size.height : cornerRadius - 2
